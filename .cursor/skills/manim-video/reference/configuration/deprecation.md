...
## deprecation - Manim Community v0.20.1
...
func (Callable[[...], T] | None) – The function to be decorated. Should not be set by the user.
...
params (str | Iterable[str] | None) – The parameters to be deprecated. Can consist of:
...
redirections (None | Iterable[tuple[str, str] | Callable[[...], dict[str, Any]]]) – A list of parameter redirections. Each redirection can be one of the following:
