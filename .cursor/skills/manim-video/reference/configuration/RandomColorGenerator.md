...
## RandomColorGenerator - Manim Community v0.20.1
...
class RandomColorGenerator(seed=None, sample_colors=None)[source]¶
Bases: object
...
sample_colors (list[ManimColor] | None) – A custom list of Manim colors to sample from. Defaults to the full Manim
color palette.
...
classmethod _random_color()[source]¶
