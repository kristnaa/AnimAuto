# Graph Layoutfunction


---

## LayoutFunction - Manim Community v0.20.1
...
Alternatively, a custom layout function can be passed to change_layout() as the layout parameter. Such a function must adhere to the LayoutFunction protocol.
