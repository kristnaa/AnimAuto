...
element_to_mobject (type[Mobject] | Callable[..., Mobject]) – The mobject class used to construct the elements, by default MathTex.
...
bracket_config (dict) – Additional arguments to be passed to MathTex when constructing
the brackets.
