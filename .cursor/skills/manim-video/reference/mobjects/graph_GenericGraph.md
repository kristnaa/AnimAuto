...
## GenericGraph - Manim Community v0.20.1
...
Must be a subclass of Line for default updaters to work.
...
any Mobject can be passed to be used as the label.
...
kwargs – Any further keyword arguments are passed to add_vertices()
